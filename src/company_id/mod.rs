...
impl Registry {
    pub fn new() -> Self {
        let entries = vec![
            ...
            RegistryEntry {
                code: "AE",
                name: "TRN",
                generate: ae::generate,
                validate: ae::validate,
            },
            RegistryEntry {
                code: "AF",
                name: "Business ID",
                generate: af::generate,
            ...
            RegistryEntry {
                code: "AL",
                name: "NIPT",
                generate: al::generate,
                validate: al::validate,
            },
            RegistryEntry {
                code: "AM",
                name: "Business ID",
            ...
            RegistryEntry {
                code: "AO",
                name: "Business ID",
                generate: ao::generate,
                validate: ao::validate,
            },
            RegistryEntry {
                code: "AQ",
                name: "Business ID",
                generate: aq::generate,
                validate: aq::validate,
            },
            RegistryEntry {
                code: "AR",
                name: "CUIT",
            ...
            RegistryEntry {
                code: "AS",
                name: "Business ID",
                generate: as_::generate,
                validate: as_::validate,
            },
            RegistryEntry {
                code: "AT",
                name: "UID",
            ...
            RegistryEntry {
                code: "AW",
                name: "Business ID",
                generate: aw::generate,
                validate: aw::validate,
            },
            RegistryEntry {
                code: "AX",
                name: "Business ID",
                generate: ax::generate,
                validate: ax::validate,
            },
            RegistryEntry {
                code: "AZ",
                name: "VOEN",
                generate: az::generate,
                validate: az::validate,
            },
            RegistryEntry {
                code: "BA",
                name: "Business ID",
                generate: ba::generate,
                validate: ba::validate,
            },
            RegistryEntry {
                code: "BB",
                name: "Business ID",
                generate: bb::generate,
                validate: bb::validate,
            },
            RegistryEntry {
                code: "BD",
                name: "Business ID",
                generate: bd::generate,
            ...
            RegistryEntry {
                code: "BH",
                name: "Business ID",
                generate: bh::generate,
                validate: bh::validate,
            },
            RegistryEntry {
                code: "BI",
                name: "Business ID",
                generate: bi::generate,
                validate: bi::validate,
            },
            RegistryEntry {
                code: "BJ",
                name: "Business ID",
                generate: bj::generate,
                validate: bj::validate,
            },
            RegistryEntry {
                code: "BL",
                name: "Business ID",
                generate: bl::generate,
                validate: bl::validate,
            },
            RegistryEntry {
                code: "BM",
                name: "Business ID",
            ...
            RegistryEntry {
                code: "BN",
                name: "Business ID",
                generate: bn::generate,
                validate: bn::validate,
            },
            RegistryEntry {
                code: "BO",
                name: "Business ID",
                generate: bo::generate,
                validate: bo::validate,
            },
            RegistryEntry {
                code: "BQ",
                name: "Business ID",
                generate: bq::generate,
                validate: bq::validate,
            },
            RegistryEntry {
                code: "BR",
                name: "CNPJ",
            ...
            RegistryEntry {
                code: "BV",
                name: "Business ID",
                generate: bv::generate,
                validate: bv::validate,
            },
            RegistryEntry {
                code: "BW",
                name: "Business ID",
                generate: bw::generate,
                validate: bw::validate,
            },
            RegistryEntry {
                code: "BY",
                name: "UNP",
                generate: by::generate,
                validate: by::validate,
            },
            RegistryEntry {
                code: "BZ",
                name: "Business ID",
                generate: bz::generate,
                validate: bz::validate,
            },
            RegistryEntry {
                code: "CA",
                name: "BN",
            ...
            RegistryEntry {
                code: "CK",
                name: "Business ID",
                generate: ck::generate,
                validate: ck::validate,
            },
            RegistryEntry {
                code: "CL",
                name: "RUT",
            ...
            RegistryEntry {
                code: "CX",
                name: "Business ID",
                generate: cx::generate,
                validate: cx::validate,
            },
            RegistryEntry {
                code: "CY",
                name: "VAT",
                generate: cy::generate,
                validate: cy::validate,
            },
            RegistryEntry {
                code: "CZ",
                name: "DIC",
            ...
            RegistryEntry {
                code: "DJ",
                name: "Business ID",
                generate: dj::generate,
                validate: dj::validate,
            },
            RegistryEntry {
                code: "DK",
                name: "CVR",
            ...
            RegistryEntry {
                code: "EH",
                name: "Business ID",
                generate: eh::generate,
                validate: eh::validate,
            },
            RegistryEntry {
                code: "ER",
                name: "Business ID",
                generate: er::generate,
            ...
            RegistryEntry {
                code: "FJ",
                name: "Business ID",
                generate: fj::generate,
                validate: fj::validate,
            },
            RegistryEntry {
                code: "FK",
                name: "Business ID",
                generate: fk::generate,
                validate: fk::validate,
            },
            RegistryEntry {
                code: "FM",
                name: "Business ID",
                generate: fm::generate,
                validate: fm::validate,
            },
            RegistryEntry {
                code: "FO",
                name: "V-number",
                generate: fo::generate,
                validate: fo::validate,
            },
            RegistryEntry {
                code: "FR",
            ...
            RegistryEntry {
                ...
                validate: ge::validate,
            },
            RegistryEntry {
                code: "GF",
                name: "Business ID",
                generate: gf::generate,
                validate: gf::validate,
            },
            RegistryEntry {
                code: "GG",
                name: "Business ID",
            ...
            RegistryEntry {
                code: "GH",
                name: "TIN",
                generate: gh::generate,
                validate: gh::validate,
            },
            RegistryEntry {
                code: "GI",
                name: "Business ID",
                generate: gi::generate,
            ...
            RegistryEntry {
                code: "GY",
                name: "Business ID",
                generate: gy::generate,
                validate: gy::validate,
            },
            RegistryEntry {
                code: "HK",
                name: "BR Number",
            ...
            RegistryEntry {
                ...
                validate: hm::validate,
            },
            RegistryEntry {
                code: "HN",
                name: "Business ID",
                generate: hn::generate,
                validate: hn::validate,
            },
            RegistryEntry {
                code: "HR",
                name: "OIB",
            ...
            RegistryEntry {
                code: "HT",
                name: "Business ID",
                generate: ht::generate,
                validate: ht::validate,
            },
            RegistryEntry {
                code: "HU",
                name: "ANUM",
                generate: hu::generate,
                validate: hu::validate,
            },
            RegistryEntry {
                code: "ID",
                name: "NPWP",
            ...
            RegistryEntry {
                code: "IM",
                name: "Business ID",
                generate: im::generate,
                validate: im::validate,
            },
            RegistryEntry {
                code: "IN",
                name: "GSTIN",
            ...
            RegistryEntry {
                code: "IQ",
                name: "Business ID",
                generate: iq::generate,
                validate: iq::validate,
            },
            RegistryEntry {
                code: "IR",
                name: "Business ID",
            ...
            RegistryEntry {
                code: "JE",
                name: "Business ID",
                generate: je::generate,
                validate: je::validate,
            },
            RegistryEntry {
                code: "JM",
                name: "Business ID",
                generate: jm::generate,
                validate: jm::validate,
            },
            RegistryEntry {
                code: "JO",
                name: "Business ID",
                generate: jo::generate,
                validate: jo::validate,
            },
            RegistryEntry {
                code: "JP",
                name: "CN",
            ...
            RegistryEntry {
                code: "KE",
                name: "PIN",
                generate: ke::generate,
                validate: ke::validate,
            },
            RegistryEntry {
                code: "KG",
                name: "Business ID",
                generate: kg::generate,
                validate: kg::validate,
            },
            RegistryEntry {
                code: "KH",
                name: "Business ID",
                generate: kh::generate,
                validate: kh::validate,
            },
            RegistryEntry {
                code: "KI",
                name: "Business ID",
                generate: ki::generate,
                validate: ki::validate,
            },
            RegistryEntry {
                code: "KM",
                name: "Business ID",
            ...
            RegistryEntry {
                ...
                validate: kn::validate,
            },
            RegistryEntry {
                code: "KP",
                name: "Business ID",
                generate: kp::generate,
            ...
            RegistryEntry {
                code: "KY",
                name: "Business ID",
                generate: ky::generate,
                validate: ky::validate,
            },
            RegistryEntry {
                code: "KZ",
                name: "Business ID",
            ...
            RegistryEntry {
                code: "LI",
                name: "PEID",
                generate: li::generate,
                validate: li::validate,
            },
            RegistryEntry {
                code: "LK",
                name: "Business ID",
                generate: lk::generate,
                validate: lk::validate,
            },
            RegistryEntry {
                code: "LR",
                name: "Business ID",
                generate: lr::generate,
                validate: lr::validate,
            },
            RegistryEntry {
                code: "LS",
                name: "Business ID",
                generate: ls::generate,
                validate: ls::validate,
            },
            RegistryEntry {
                code: "LT",
                name: "PVM",
                generate: lt::generate,
            ...
            RegistryEntry {
                code: "LY",
                name: "Business ID",
                generate: ly::generate,
                validate: ly::validate,
            },
            RegistryEntry {
                code: "MA",
                name: "ICE",
                generate: ma::generate,
                validate: ma::validate,
            },
            RegistryEntry {
                code: "MC",
                name: "TVA",
                generate: mc::generate,
            ...
            RegistryEntry {
                ...
                validate: mg::validate,
            },
            RegistryEntry {
                code: "MH",
                name: "Business ID",
                generate: mh::generate,
                validate: mh::validate,
            },
            RegistryEntry {
                code: "MK",
                name: "EDB",
                generate: mk::generate,
            ...
            RegistryEntry {
                code: "MN",
                name: "Business ID",
                generate: mn::generate,
                validate: mn::validate,
            },
            RegistryEntry {
                code: "MO",
                name: "Business ID",
                generate: mo::generate,
                validate: mo::validate,
            },
            RegistryEntry {
                code: "MP",
                name: "Business ID",
                generate: mp::generate,
                validate: mp::validate,
            },
            RegistryEntry {
                code: "MQ",
                name: "Business ID",
                generate: mq::generate,
                validate: mq::validate,
            },
            RegistryEntry {
                code: "MR",
                name: "Business ID",
            ...
            RegistryEntry {
                code: "MZ",
                name: "NUIT",
                generate: mz::generate,
                validate: mz::validate,
            },
            RegistryEntry {
                code: "NA",
                name: "Business ID",
                generate: na::generate,
            ...
            RegistryEntry {
                code: "NI",
                name: "Business ID",
                generate: ni::generate,
                validate: ni::validate,
            },
            RegistryEntry {
                code: "NL",
                name: "BTW",
            ...
            RegistryEntry {
                code: "NR",
                name: "Business ID",
                generate: nr::generate,
                validate: nr::validate,
            },
            RegistryEntry {
                code: "NU",
                name: "Business ID",
                generate: nu::generate,
            ...
            RegistryEntry {
                code: "SJ",
                name: "Business ID",
                generate: sj::generate,
                validate: sj::validate,
            },
            RegistryEntry {
                code: "SK",
                name: "IC DPH",
            ...
            RegistryEntry {
                code: "SN",
                name: "NINEA",
                generate: sn::generate,
                validate: sn::validate,
            },
            RegistryEntry {
                code: "SO",
                name: "Business ID",
                generate: so::generate,
                validate: so::validate,
            },
            RegistryEntry {
                code: "SR",
                name: "Business ID",
                generate: sr::generate,
            ...
            RegistryEntry {
                code: "SV",
                name: "NIT",
                generate: sv::generate,
                validate: sv::validate,
            },
            RegistryEntry {
                code: "SX",
                name: "Business ID",
                generate: sx::generate,
                validate: sx::validate,
            },
            RegistryEntry {
                code: "SY",
                name: "Business ID",
                generate: sy::generate,
                validate: sy::validate,
            },
            RegistryEntry {
                code: "SZ",
                name: "Business ID",
                generate: sz::generate,
            ...
            RegistryEntry {
                code: "TJ",
                name: "Business ID",
                generate: tj::generate,
                validate: tj::validate,
            },
            RegistryEntry {
                code: "TK",
                name: "Business ID",
                generate: tk::generate,
                validate: tk::validate,
            },
            RegistryEntry {
                code: "TL",
                name: "Business ID",
                generate: tl::generate,
                validate: tl::validate,
            },
            RegistryEntry {
                code: "TM",
                name: "Business ID",
                generate: tm::generate,
                validate: tm::validate,
            },
            RegistryEntry {
                code: "TN",
                name: "MF",
                generate: tn::generate,
            ...
            RegistryEntry {
                code: "TZ",
                name: "Business ID",
                generate: tz::generate,
                validate: tz::validate,
            },
            RegistryEntry {
                code: "UA",
                name: "EDRPOU",
            ...
            RegistryEntry {
                code: "UG",
                name: "Business ID",
                generate: ug::generate,
                validate: ug::validate,
            },
            RegistryEntry {
                code: "UM",
                name: "Business ID",
                generate: um::generate,
                validate: um::validate,
            },
            RegistryEntry {
                code: "US",
                name: "EIN",
            ...
            RegistryEntry {
                code: "UZ",
                name: "Business ID",
                generate: uz::generate,
                validate: uz::validate,
            },
            RegistryEntry {
                code: "VA",
                name: "Business ID",
                generate: va::generate,
                validate: va::validate,
            },
            RegistryEntry {
                code: "VC",
                name: "Business ID",
                generate: vc::generate,
            ...
            RegistryEntry {
                code: "VI",
                name: "Business ID",
                generate: vi::generate,
                validate: vi::validate,
            },
            RegistryEntry {
                code: "VN",
                name: "MST",
                generate: vn::generate,
                validate: vn::validate,
            },
            RegistryEntry {
                code: "VU",
                name: "Business ID",
                generate: vu::generate,
                validate: vu::validate,
            },
            RegistryEntry {
                code: "WF",
                name: "Business ID",
            ...
            RegistryEntry {
                code: "XK",
                name: "Business ID",
                generate: xk::generate,
                validate: xk::validate,
            },
            RegistryEntry {
                code: "YE",
                name: "Business ID",
                generate: ye::generate,
                validate: ye::validate,
            },
            RegistryEntry {
                code: "YT",
                name: "Business ID",
                generate: yt::generate,
            ...
            RegistryEntry {
                code: "ZM",
                name: "Business ID",
                generate: zm::generate,
                validate: zm::validate,
            },
            RegistryEntry {
                code: "ZW",
                name: "Business ID",
                generate: zw::generate,
                validate: zw::validate,
            },
        ];
        Self { entries }
    }
    ...
    pub fn generate(
        ...
        if let Some(entry) = self.find(&country) {
            return Some(CompanyResult {
                ...
                country_name: crate::countries::get_country_name(&country)
                    .unwrap_or("Unknown")
                    .to_string(),
    ...
    pub fn list_countries(&self) -> Vec<(&'static str, &'static str, &'static str)> {
        ...
        for entry in &self.entries {
            result.push((
                entry.code,
                crate::countries::get_country_name(entry.code).unwrap_or("Unknown"),
                entry.name,
            ));
        }
