...
pub fn generate(rng: &mut rand::rngs::ThreadRng) -> String {
    ...
    for _ in 0..6 { s.push((b'0' + rng.gen_range(0..=9u8)) as char); }
    s
}
...
pub fn validate(code: &str) -> bool {
    ...
    match class {
        ...
        '3' => ["002", "003", "004", "005", "006", "007", "008", "009", "010", "011", "012", "013", "014", "101", "102", "103", "104", "105", "106", "107", "108", "109", "110"].contains(&type_val),
        '4' => type_val == "000",
        '5' => type_val == "001",
        _ => false,
    }
