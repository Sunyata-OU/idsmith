...
pub fn generate(rng: &mut rand::rngs::ThreadRng) -> String {
    ...
    for _ in 0..12 { s.push((b'0' + rng.gen_range(0..=9)) as char); }
...
pub fn validate(code: &str) -> bool {
    ...
    let alphabet = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
    if !clean.chars().next().unwrap().is_ascii_alphabetic() { return false; }
    ...
    Some(alphabet.chars().nth(expected_idx as usize).unwrap()) == clean.chars().last()
}
