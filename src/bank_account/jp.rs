...
pub fn generate(_opts: &GenOptions, rng: &mut impl Rng) -> AccountResult {
    ...
    AccountResult {
        ...
        country_name: crate::countries::get_country_name("JP").unwrap_or("Unknown").to_string(),
